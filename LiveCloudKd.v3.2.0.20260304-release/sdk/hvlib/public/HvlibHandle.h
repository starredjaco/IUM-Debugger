...
FUNCTION_TYPE ULONG64 SdkSymGetSymbolAddress2(_In_ ULONG64 PartitionHandle, _In_ const char* moduleName, _In_ const char* symbolName, _In_ MEMORY_ACCESS_TYPE MmAccess);
